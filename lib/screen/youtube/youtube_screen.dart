...
import 'generated_youtube_screen.dart';
...
class _YoutubeScreenState extends State<YoutubeScreen> {
  ...
  void _generateQRCode() {
    ...
    // Kiểm tra URL có thuộc về Youtube hay không
    ...
    // Nếu URL hợp lệ và thuộc về Youtube, chuyển sang màn hình hiển thị QR code
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GeneratedYoutubeScreen(
          data: inputText,
        ),
      ),
    );
