...
import 'generated_spotify_screen.dart';
...
// Kiểm tra URL có thuộc về Spotify hay không
    ...
    // Nếu URL hợp lệ và thuộc về Spotify, chuyển sang màn hình hiển thị QR code
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GeneratedSpotifyScreen(
          data: inputText,
        ),
      ),
    );
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Enter link to your favourite song",
                    style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                          fontWeight: FontWeight.bold,
                          fontSize: 20,
                        ),
