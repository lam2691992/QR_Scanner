...
class GeneratedAppStoreScreen extends StatelessWidget {
  final String data;
  final GlobalKey _globalKey = GlobalKey();
  GeneratedAppStoreScreen({super.key, required this.data});
            ...
            children: [
              RepaintBoundary(
                ...
                child: Container(
                  ...
                  child: QrImageView(
                    data:
                        _ensureUrlFormat(data), // Đảm bảo dữ liệu là URL hợp lệ
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      getFormattedData(
                          data), // Hiển thị nội dung người dùng nhập
